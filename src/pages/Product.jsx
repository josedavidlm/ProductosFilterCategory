            ...
            <div className="container mx-auto px-6">
                <div className="md:flex md:items-center">
                    <div className="w-full h-64 md:w-1/2 lg:h-full">
                        <img className="h-full w-full rounded-md object-cover max-w-lg mx-auto" src={product.image} alt="Nike Air" />
                    </div>
                    <div className="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                        <h3 className="text-gray-700 uppercase text-lg font-bold">{product.title}</h3>
                        ...
                        <hr className="my-3" />
                            ...
                            <div className="mt-3">
                                <label className="text-gray-700 text-xl font-bold" for="count">Description:</label>
